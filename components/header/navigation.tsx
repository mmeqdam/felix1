      ...
      <div className="flex items-center justify-between h-16 px-6">
        ...
        <div className="flex items-center space-x-2 space-x-reverse">
          ...
          <button 
            ...
            aria-label="الحساب"
            onClick={() => user ? setOffCanvasType('account') : router.push('/auth')}
          >
            <User size={20} />
          </button>
          <button 
              ...
              <div className="flex space-x-6">
                {navItems
                  ...
                  ?.images.map((image, index) => (
                    <Link key={index} href={image.href} className="w-[400px] h-[280px] cursor-pointer group relative overflow-hidden block">
                      <img 
                        src={image.src}
                        alt={image.alt}
